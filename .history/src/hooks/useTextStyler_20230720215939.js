const useTextStyler = () => {
  ...
  const getCaretInfoFromNodes = (nodes) => {
    const dragInfo = {};
    const range = document.getSelection().getRangeAt(0);

    const { startOffset, endOffset, startContainer, endContainer } = range;
    console.log("startContainer.parentElement: ", startContainer.parentElement);
    console.log(startContainer.parentElement.closest("[data-uuuid]"));
    //const nodes =
