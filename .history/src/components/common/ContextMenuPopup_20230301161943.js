...
const ContextMenuPopup = ({
  ...
  const changeTextStyle = (style) => {
    ...
    console.log("newHtmlData.html : ", typeof newHtmlData.html);
    console.log(typeof document.createElement(newHtmlData.html));
    console.log(
      "document.createElement : ",
      typeof document.createElement("a")
    );
    editableTag.appendChild(document.createElement("a"));
      ...
      if (styleKeys.length > 0) {
        ...
        if (node.link.length > 0) {
          ...
          linkTag.addEventListener("click", function (event) {
            ...
            console.log("링크 클릭됨:", event.target.href);
          });
