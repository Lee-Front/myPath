...
const ContextMenuPopup = ({
  ...
  useEffect(() => {
    ...
    if (
      ...
      selection.baseNode.parentElement.nodeName === "SPAN"
    ) {
      const parentElementData = selection.baseNode.parentElement;
      console.log("선택된 노드가 1개");
      console.log("base : ", parentElementData);
    } else {
      // 여기서는 뭐 할게없넹
