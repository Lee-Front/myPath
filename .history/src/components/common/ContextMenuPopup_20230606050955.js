...
const ContextMenuPopup = ({
  ...
  useEffect(() => {
    ...
    // 모든 배열에 공통으로 있는 속성명을 필터링합니다.
    const commonAttributes = attributes.filter((attribute) => {
      return styleArray.every(
        (obj) =>
          obj.hasOwnProperty(attribute) && typeof obj[attribute] !== "undefined"
      );
    });
