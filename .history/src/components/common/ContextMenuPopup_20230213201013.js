...
const ContextMenuPopup = ({
  ...
  const checkStyleIndex = (anchorOffset, focusOffset, style) => {
    if (anchorOffset !== focusOffset) {
      ...
      const selection = window.getSelection().setPosition(editableTag, 2);
      console.log(...selection);
      // range.selectNodeContents(editableTag);
      // range.setStart(editableTag, 0);
      // range.setEnd(editableTag, 1);
