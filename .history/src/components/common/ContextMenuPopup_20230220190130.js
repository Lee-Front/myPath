      ...
      if (startNodeIndex <= i && i <= endNodeIndex) {
        ...
        if (startNodeIndex === endNodeIndex) {
          ...
          if (prevText.length > 0) {
            ...
            returnData.startOffset = 0;
            returnData.endNodeIndex += 1;
            const splitNode1 = JSON.parse(JSON.stringify(nodeData));
            console.log("splitNode1: ", { ...splitNode1 });
            splitNode1.textContent = prevText;
            console.log("splitNode2: ", { ...splitNode1 });
            newNodeList.splice(i, 0, splitNode1);
          }
