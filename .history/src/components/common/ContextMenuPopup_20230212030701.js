...
const TextMenu = styled.div`
  ...
  border: ${(props) => {
    return props.border ? "0.2rem solid rgba(55, 53, 47, 0.2)" : null;
  }};
...
const ContextMenuPopup = ({
  ...
  const [bold, setBold] = useState(popupData?.styleData?.bold || false);

  console.log("bold : ", popupData?.styleData?.bold);
  console.log(" || :", popupData?.styleData?.bold || false);
  ...
  const changeBackground = async (modifyColor) => {
    console.log("modifyColor: ", modifyColor);
