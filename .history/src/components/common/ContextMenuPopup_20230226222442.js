...
const ContextMenuPopup = ({
  ...
  const changeTextAlignment = (modifyAlign) => {
    if (popupData?.styleData?["justify-content"] !== modifyAlign) {
      modifyEditDom(
        popupData.uuid,
        {
          styleData: { ...popupData?.styleData, "justify-content": modifyAlign },
        },
        "style"
      );
    }
