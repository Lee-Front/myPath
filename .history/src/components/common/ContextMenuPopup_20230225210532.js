...
const ContextMenuPopup = ({
  ...
  useEffect(() => {
    ...
    if (
      ...
      const commonProps = Object.keys(arr[0]).filter((prop) => {
        return arr.every((obj) => Object.keys(obj).includes(prop));
      });
      ...
      let allSpanNodes = true;
      const duplicationStyle = [];
      ...
      console.log("allSpanNodes: ", allSpanNodes);
      if (allSpanNodes) {
      }
    }
  }, []);
