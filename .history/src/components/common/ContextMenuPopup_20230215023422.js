...
const ContextMenuPopup = ({
  ...
  const checkStyleIndex = (anchorOffset, focusOffset, html, style) => {
    if (anchorOffset !== focusOffset) {
      // console.log("editableTag : ", editableTag.childNodes);
      // const newHtml = changeNodeContent(style, html, anchorOffset, focusOffset);
      // modifyEditDom(uuid, {
  ...
  const changeNodeContent = (anchorOffset, focusOffset, html, style) => {
    let newHtml = "";
