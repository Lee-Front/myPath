...
const ContextMenuPopup = ({
  ...
  const copyConsole = (name, target) => {
    console.log(name, " : ", JSON.parse(JSON.stringify(target)));
  };
  ...
  const makeNewHtml = (nodes, range, style) => {
    ...
    const dragInfo = {};
    copyConsole("nodeDatas", nodeDatas);
    ...
    copyConsole("splitedNodeDatas", splitedNodeDatas);
    ...
    copyConsole("styledNodeDatas", styledNodeDatas);
    const { mergedNodeDatas, mergedDragInfo } = mergedNodesWithSameStyle(
      styledNodeDatas,
      splitedDragInfo
    );
    copyConsole("mergedNodeDatas", mergedNodeDatas);
  ...
  const getNodesData = (nodes) => {
    return nodes.map((node) => {
      ...
      copyConsole("nodeObject: ", nodeObject);
