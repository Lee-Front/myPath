...
const ContextMenuPopup = ({
  ...
  const changeTextStyle = (style) => {
    ...
    //       changeBackground(style["background-color"]);
    //     } else if (key === "font-weight") {
    //       changeBold(style["font-weight"]);
    //     } else if (key === "font-style") {
    //       changeItalic(style["font-style"]);
    //     } else if (key === "border-bottom") {
    //       changeUnderLine(style["border-bottom"]);
    //     } else if (key === "text-decoration") {
    //       changeStrikethrough(style["text-decoration"]);
    //     }
    //   });
    // }
    ...
    console.log("selection.extentNode: ", selection.extentNode);

    console.log("editableTag.firstChild : ", editableTag.firstChild);
    console.log("editableTag.lastChild : ", editableTag.lastChild);
    const isSelectionFull =
      selection.baseNode === editableTag.firstChild &&
      selection.extentNode === editableTag.lastChild;
    console.log("isSelectionFull : ", isSelectionFull);
