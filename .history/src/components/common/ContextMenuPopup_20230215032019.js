...
const ContextMenuPopup = ({
  ...
  const checkStyleIndex = (anchorOffset, focusOffset, style) => {
    if (anchorOffset !== focusOffset) {
      ...
      const nodes = editableTag.childNodes;
      const test = Array.from(nodes);
      console.log("startContainer1  : ", startContainer);
      console.log("endContainer1  : ", endContainer);
      console.log("startContainer: ", nodes.indexOf(startContainer));
      console.log("endContainer: ", nodes.indexOf(endContainer));
      if (nodes.length > 1) {
