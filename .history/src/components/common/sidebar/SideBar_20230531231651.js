...
import { disassemble, compose } from "hangul-js";
...
const SideBar = ({ isSideBarOpen }) => {
  ...
  const text = "테스트";
  const decomposedText = disassemble(text);
  console.log("decomposedText : ", decomposedText);

  const searchString = "ㅌ";
  const decomposedSearch = disassemble(searchString);
  console.log("decomposedSearch : ", decomposedSearch);

  const isIncluded = decomposedText.includes(decomposedSearch);

  console.log("isIncluded: ", isIncluded); // true
