...
const SideBar = ({ isSideBarOpen }) => {
  ...
  const text = "테스트";
  const arrayText = Array.from(text.normalize("NFD"));
  console.log("arrayText : ", arrayText);
  console.log("a : ", typeof arrayText[0]);
  console.log("a : ", arrayText[0].charCodeAt(0));
  console.log("a : ", typeof "ㅌ");
  console.log("a : ", "ㅌ".charCodeAt(0));
  console.log("in : ", arrayText.includes(arrayText[0]));
