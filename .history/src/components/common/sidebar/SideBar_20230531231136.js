...
const SideBar = ({ isSideBarOpen }) => {
  ...
  const searchDecomposed = Array.from(searchString.normalize("NFD"));

  console.log("decomposedText : ", decomposedText[0].charCodeAt(0));
  console.log("aa : ", searchDecomposed[0].charCodeAt(0));
  const isIncluded = decomposedText.includes(searchDecomposed[0].charCodeAt(0));
