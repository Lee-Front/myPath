...
const ContextMenuPopup = ({
  ...
  const checkStyleIndex = (anchorOffset, focusOffset, style) => {
    if (anchorOffset !== focusOffset) {
      ...
      const { baseNode, extentNode } = range;
      ...
      console.log("baseNode1  : ", baseNode);
      console.log("extentNode2  : ", extentNode);
      console.log("baseNode: ", test.indexOf(baseNode));
      console.log("extentNode: ", test.indexOf(extentNode));
      if (nodes.length > 1) {
