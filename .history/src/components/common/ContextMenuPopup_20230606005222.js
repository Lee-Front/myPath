...
const ContextMenuPopup = ({
  ...
  useEffect(() => {
    ...
    const startNode = range.baseNode;
    const endNode = range.extentNode;
    ...
    let selectedNodes = nodes.slice(
      Math.min(startNodeIndex, endNodeIndex),
      Math.max(startNodeIndex, endNodeIndex) + 1
    );
