      ...
      <CardEditorContentWrapper
        ...
        onClick={() => {
          if (!nearElement) {
            ...
            console.log(Array.from(editorRef.current.children));
            const newElement = Array.from(editorRef.current.children).filter(
              (item) => {
                console.log(editorRef.current.children);
                console.log("el :", item);
                console.log("el :", item.uuid);
                console.log("newUuid : ", newUuid);
                if (item.uuid === newUuid) {
                  return item;
                }
              }
            );
