...
const CardEditor = ({ pathId }) => {
  ...
  useEffect(() => {
    ...
    console.log("a");
    window.addEventListener("mouseleave", attachEvent);
    window.addEventListener("mouseenter", detachEvent);
    ...
    return () => {
      window.removeEventListener("mouseleave", attachEvent);
      window.removeEventListener("mouseenter", detachEvent);
      // window.removeEventListener("mousedown", windowMouseDown);
      // window.removeEventListener("mouseup", windowMouseUp);
      // window.removeEventListener("mousemove", windowMouseMove);
    };
