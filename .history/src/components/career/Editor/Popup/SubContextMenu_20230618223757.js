...
const SubContextMenu = ({
  ...
  const menuList = [{meneText:"삭제",onClick:deleteMenu},
  {meneText:"변경",onClick:changeMenu},
  {menuText:"정렬",subMenuList:[{text:"왼쪽",isSelect:popupData?.styleData?.textAlign === "flex-start",event:()=>{changeTextAlignment("start")}},
  {meneText:"링크",onClick:handleLinkClick}
];
