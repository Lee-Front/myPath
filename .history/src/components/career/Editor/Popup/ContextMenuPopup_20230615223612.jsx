...
const ContextMenuPopup = ({
  ...
  const handleToggle = (toggleType, styleProp) => {
    toggleType((prevState) => !prevState);
    const style = { [styleProp]: !toggleType ? "" : styleProp };
    changeTextStyle(uuid, style);
  };
    ...
    >
      <TextMenuWrapper>
        ...
        <TextMenuButton
          ...
          buttonType={"bold"}
          onMouseEnter={changeSelectSubMenu}
          onClick={handleToggle(setBold, "font-weight")}
        >
          B
        </TextMenuButton>
