...
const ContextMenuPopup = ({
  ...
  const subContextMenuList = [
    { menuText: "삭제", onClick: deleteMenu },
    { menuText: "변경", onClick: changeMenu },
    {
      menuText: "정렬",
      menuList: [
        { text: "왼쪽", event: changeTextAlignment("start") },
        { text: "왼쪽", event: changeTextAlignment("center") },
        { text: "왼쪽", event: changeTextAlignment("end") },
      ],
    },
    { menuText: "링크", onClick: handleLinkClick },
  ];
  console.log("subContextMenuList: ", subContextMenuList);
  return (
    <ContextMenuWarpper
      ref={contextRef}
      pointer={pointer}
