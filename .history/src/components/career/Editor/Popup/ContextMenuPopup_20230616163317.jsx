    ...
    >
      <TextMenuWrapper>
        ...
        <TextColorMenu
          ...
          color={color}
          setColor={setColor}
          handleColorChange={() => handleStateChange("", setColor, "color", "")}
          changeTextStyle={changeTextStyle}
        >
          A
        </TextColorMenu>
        ...
        <TextColorMenu
          ...
          handleToggle={handleStateChange}
          changeTextStyle={changeTextStyle}
        >
          배경
        </TextColorMenu>
        ...
        <TextMenuButton
          ...
          onMouseEnter={changeSelectSubMenu}
          onClick={() =>
            handleStateChange(!bold, setBold, "font-weight", "bold")
          }
        >
          B
        </TextMenuButton>
        ...
        <TextMenuButton
          ...
          onMouseEnter={changeSelectSubMenu}
          onClick={() =>
            handleStateChange(!italic, setItalic, "font-style", "italic")
          }
        >
          i
        </TextMenuButton>
