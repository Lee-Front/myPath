...
const SubContextMenu = ({
  ...
  useEffect(() => {
    ...
    if (selectMenu && subMenuPopup) {
      const { top, right } = selectMenu.getBoundingClientRect();
      console.log("offsetTop : ", selectMenu.offsetTop);
      console.log("offsetLeft : ", selectMenu.offsetLeft);
      console.log("offsetWidth : ", selectMenu.offsetWidth);
      const { width } = subMenuPopup.getBoundingClientRect();
      setMenuPoint({ x: -width, y: 0 });
      console.log("selectMenu : ", selectMenu.getBoundingClientRect());
      console.log("subMenuPopup: ", subMenuPopup.getBoundingClientRect());
    }
