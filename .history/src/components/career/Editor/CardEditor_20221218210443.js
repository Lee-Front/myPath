    ...
    if (targetElement && selectElements.length > 0) {
      ...
      if (parentData) {
        if (parentData.direction === "column") {
          ...
          const parentPrevData = siblingData.prevData;
          const parentNextData = siblingData.nextData;
          console.log("parentPrevData: ", parentPrevData);
          console.log("parentNextData: ", parentNextData);
        }
        //targetElementData.uuid = parentData.uuid;
      }
