...
const CardEditor = ({ pathId }) => {
  ...
  useEffect(() => {
    ...
    document.addEventListener("mouseout", attachEvent);
    document.addEventListener("mouseover", detachEvent);
    ...
    return () => {
      document.removeEventListener("mouseout", attachEvent);
      document.removeEventListener("mouseover", detachEvent);
      // window.removeEventListener("mousedown", windowMouseDown);
      // window.removeEventListener("mouseup", windowMouseUp);
      // window.removeEventListener("mousemove", windowMouseMove);
    };
