...
const CardEditor = ({ pathId }) => {
  ...
  useEffect(() => {
    ...
    window.addEventListener("mousedown", eventRef.mouseDown);
    window.addEventListener("mouseup", eventRef.mouseUp);
    window.addEventListener("mousemove", eventRef.mouseMove);
    return () => {
      window.removeEventListener("mousedown", eventRef.mouseDown);
      window.removeEventListener("mouseup", eventRef.mouseUp);
      window.removeEventListener("mousemove", eventRef.mouseMove);
    };
