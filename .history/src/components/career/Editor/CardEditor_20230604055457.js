...
const CardEditor = ({ pathId }) => {
  ...
  useEffect(() => {
    ...
    document.addEventListener("mouseenter", attachWindowEvent);
    document.addEventListener("mouseleave", detachWindowEvent);
    // return () => {
    document.removeEventListener("mouseenter", attachWindowEvent);
    document.removeEventListener("mouseleave", detachWindowEvent);
    // };
