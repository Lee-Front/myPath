...
const CardEditor = ({ pathId }) => {
  ...
  const filterByKey = (elementList, key, value) => {
    ...
    console.log("isLogicalNot: ", isLogicalNot);
    console.log("value : ", value);
    const filterValue = isLogicalNot ? value.splice(0, 1) : value;
    return elementList.filter((element) =>
      isLogicalNot ? element[key] !== filterValue : element[key] === filterValue
    );
  };
