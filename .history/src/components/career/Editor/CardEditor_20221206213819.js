...
const CardEditor = () => {
  ...
  const testArray = [
    ...
    { uuid: "5", html: "5", parentId: "4", tagName: "div" },
    { uuid: "6", html: "6", parentId: "4", tagName: "div" },
    { uuid: "7", html: "7", parentId: "4", tagName: "div" },
    { uuid: "2", html: "2", parentId: "1", tagName: "div" },
    { uuid: "3", html: "3", parentId: "1", tagName: "div" },
    { uuid: "8", html: "8", parentId: null, tagName: "div" },
    {
      uuid: "4",
      html: "4",
      parentId: null,
  ...
  function list_to_tree(list) {
    ...
    for (i = 0; i < list.length; i += 1) {
      ...
      list[i].multipleData = []; // initialize the children
    }
    ...
    for (i = 0; i < list.length; i += 1) {
      ...
      if (node.parentId) {
        ...
        console.log("list[map[node.parentId]] : ", list[map[node.parentId]]);
  ...
  const testDom2 = list_to_tree(testArray);

  const [editDom, setEditDom] = useState(testDom2);
