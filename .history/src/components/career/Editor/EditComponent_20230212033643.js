...
const EditComponent = ({
  ...
  return (
    ...
    >
      ...
      >
        {state.styleData?.bold ? "true" : "false"}
        {state.styleData?.italic ? "true" : "false"}
        {state.styleData?.underLine ? "true" : "false"}
        {state.styleData?.bold ||
        state.styleData?.italic ||
        state.styleData?.underLine ? (
