...
const CardEditor = ({ pathId }) => {
  ...
  useEffect(() => {
    ...
    console.log("a");
    document.addEventListener("pointerleave", attachEvent);
    document.addEventListener("pointerenter", detachEvent);
    ...
    return () => {
      document.removeEventListener("mouseleave", attachEvent);
      document.removeEventListener("mouseenter", detachEvent);
      // window.removeEventListener("mousedown", windowMouseDown);
      // window.removeEventListener("mouseup", windowMouseUp);
      // window.removeEventListener("mousemove", windowMouseMove);
    };
