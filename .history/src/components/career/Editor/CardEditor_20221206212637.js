...
const CardEditor = () => {
  ...
  const testArray = [
    { id: "1", html: "1", parentId: null, children: [] },
    { id: "2", html: "2", parentId: "1", children: [] },
    { id: "3", html: "3", parentId: "1", children: [] },
    { id: "4", html: "4", parentId: null, children: [] },
    { id: "5", html: "5", parentId: "4", children: [] },
    { id: "6", html: "6", parentId: "4", children: [] },
    { id: "7", html: "7", parentId: "4", children: [] },
    { id: "8", html: "8", parentId: null, children: [] },
  ];

  const dom = [];
  const makeTree = (domList) => {
    domList.map((item) => {
