...
const CardEditor = ({ pathId }) => {
  ...
  const getTagList = async () => {
    ...
    modifyDomSave(editDom, newEditDom);
  ...
  const modifyDomSave = (prevEditDom, newEditDom) => {
    //const prevEditDom = editDom.map((element) => Object.assign({}, element));
    console.log("prevEditDom : ", { ...prevEditDom });
