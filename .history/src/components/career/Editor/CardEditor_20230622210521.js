...
const CardEditor = ({ pathId }) => {
  ...
  const windowMouseDown2 = useRef((e) => {
    if (
      !isFileUploderOpen &&
      !isContextMenuOpen &&
  ...
  return (
    <EditorContainer
      onMouseLeave={(e) => {
        console.log("lev");
        window.addEventListener("mousedown", windowMouseDown2.current);
        window.addEventListener("mouseup", windowMouseUp);
        window.addEventListener("mousemove", windowMouseMove);
      }}
      onMouseEnter={(e) => {
        console.log("enter");
        window.removeEventListener("mousedown", windowMouseDown2.current);
        window.removeEventListener("mouseup", windowMouseUp);
        window.removeEventListener("mousemove", windowMouseMove);
      }}
