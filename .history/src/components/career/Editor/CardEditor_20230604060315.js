...
const CardEditor = ({ pathId }) => {
  ...
  useEffect(() => {
    getTagList();
    document.addEventListener("pointerenter", detachWindowEvent);
    document.addEventListener("pointerleave", attachWindowEvent);
    return () => {
      document.removeEventListener("pointerenter", detachWindowEvent);
      document.removeEventListener("pointerleave", attachWindowEvent);
    };
  }, []);
