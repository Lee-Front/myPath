  ...
  const moveElementData = () => {
    ...
    if (targetData.parentId) {
      ...
      if (
        ...
        fromDatas[0].parentId = newElement.uuid;
      ...
      if (
        ...
        if (movementData.position === "left") {
          ...
          newEditDom.splice(toIndex, 0, newColumElement1);
          newEditDom.splice(toIndex, 0, ...fromDatas);
          newEditDom.splice(toIndex, 0, newColumElement2);
        } else {
          newEditDom.splice(toIndex + 1, 0, newColumElement1);
          newEditDom.splice(toIndex, 0, newElement);
          newEditDom.splice(toIndex, 0, newColumElement2);
        }
      } else {
        if (movementData?.movementSideType === "text") {
          ...
          fromDatas[0].parentId = null;
        }
      }
    }

    newEditDom.splice(moveIndex, 0, fromDatas[0]);
