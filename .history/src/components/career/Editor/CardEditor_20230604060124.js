...
const CardEditor = ({ pathId }) => {
  ...
  useEffect(() => {
    getTagList();
    window.addEventListener("mouseenter", detachWindowEvent);
    window.addEventListener("mouseleave", attachWindowEvent);
    return () => {
      window.removeEventListener("mouseenter", detachWindowEvent);
      window.removeEventListener("mouseleave", attachWindowEvent);
    };
  }, []);
