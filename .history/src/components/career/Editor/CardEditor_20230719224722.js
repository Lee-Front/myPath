...
const CardEditor = ({ pathId, readonly }) => {
  ...
  useEffect(() => {
    console.log("a");
    const scrollMove = () => {
      // console.log(editorRef.current.scrollTop);
      // console.log(editorRef.current.scrollHeight);
      // console.log(editorRef.current.clientHeight + editorRef.current.scrollTop);
