...
const CardEditor = ({ pathId }) => {
  ...
  useEffect(() => {
    getTagList();
    window.removeEventListener("mouseenter", windowMouseDown);
    window.removeEventListener("mouseenter", windowMouseUp);
    window.removeEventListener("mouseenter", windowMouseMove);

    return () => {
      window.addEventListener("mouseenter", windowMouseDown);
      window.addEventListener("mouseenter", windowMouseUp);
      window.addEventListener("mouseenter", windowMouseMove);
    };
