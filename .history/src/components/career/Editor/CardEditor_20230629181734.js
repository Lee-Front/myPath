...
const CardEditor = ({ pathId }) => {
  ...
  useEffect(() => {
    ...
    window.addEventListener("mousedown", mouseEventRef.current.mouseDown);
    window.addEventListener("mouseup", mouseEventRef.current.mouseUp);
    window.addEventListener("mousemove", mouseEventRef.current.mouseMove);
    return () => {
      window.removeEventListener("mousedown", mouseEventRef.current.mouseDown);
      window.removeEventListener("mouseup", mouseEventRef.current.mouseUp);
      window.removeEventListener("mousemove", mouseEventRef.current.mouseMove);
    };
