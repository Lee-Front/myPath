...
const PathList = () => {
  ...
  const getPathList = async (userId) => {
    console.log("asd");
    // const pathList = await axios.get("https://13.231.122.97/api/path/getList");
    const pathList = await axios.get("https://54.238.222.207/api/path/getList");
